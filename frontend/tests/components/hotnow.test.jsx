...
describe("HotNow component", () => {
  ...
  it("renders movies fetched from API", async () => {
    ...
    const { container } = testUtils.renderWithRouter(<HotNow />);
  ...
  it("handles fetch errors gracefully", async () => {
    ...
    testUtils.renderWithRouter(<HotNow />);
